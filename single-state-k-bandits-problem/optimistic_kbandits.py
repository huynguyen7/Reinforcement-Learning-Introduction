#!/Users/nguyenhuy/opt/miniconda3/envs/LinearAlgebra/bin/python3 
...
"""
    ...
    *THIS IMPLEMENTATION USES `Epsilon Greedy Method` APPROACH.
    Just a little modification to this file.. since Q are not initialized to 0 all the time. This approach shows that initial assumed Q values increases a fair amount of exploration even than the setting Q to zeros..
"""
